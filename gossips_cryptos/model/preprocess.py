...
def preprocess_features(cleaned_data: pd.DataFrame,window=40,horizon=1,fold_size=0.8) -> np.ndarray:
    ...
    def window_data(cleaned_data):
        ...
        feature_column = [df.columns.get_loc(col) for col in cols_to_find]
